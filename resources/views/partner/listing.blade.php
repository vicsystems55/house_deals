                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$listing_data->name}}" name="property_name" class="form-control" placeholder="Property Name">
                            </div>


                            <div class="form-group">
                                <label for="">Description:</label>
                             <textarea name="description" value="{{$listing_data->description}}" class="form-control" placeholder="Describe the property" id="" cols="30" rows="5"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$listing_data->location}}" class="form-control" placeholder="Property location / address">
                            </div>

                            
                            <div class="form-group">
                                <label for="">Google map url:</label>
                                <input type="text" name="google_map_url" value="{{$listing_data->google_map_url}}" class="form-control" placeholder="Google map url">
                            </div>

                            <div class="form-group">
                                <label for="">Worth:</label>
                                <input type="text" name="price" value="{{$listing_data->price}}" class="form-control" placeholder="What is the value of this property?">
                            </div>

                            
                            <div class="form-group">
                                <label for="">Number of units:</label>
                                <input type="number" name="no_units" value="{{$listing_data->no_units}}" class="form-control" >
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <uploader-component listingcode="{{$listing_data->listing_code}}" appurl="{{config('app.url')}}"></uploader-component>
